...
#define SHAPE_THRESH 4.2 //how much longer an object's length is compared to its width. 1 is a square
...
#define BOUNDING_RECT_SCALE_FACTOR 1.9

#define TRAIN_PATH_NEG "//home/frank/cv_ros_ws/src/ViCAS/leopard_imaging_camera/training/neg/"
#define TRAIN_PATH_POS "//home/frank/cv_ros_ws/src/ViCAS/leopard_imaging_camera/training/pos/"
...
class CopterTrackerV2
{
        ...
        pcloud_roi_in(new pcl::PointCloud<pcl::PointXYZ>)
    {
        ...
        image_sub_rgb = iTrans.subscribe("/stereo/left/image_rect", 1, &CopterTrackerV2::callback_rgb, this); //TODO  sub to image_rect and use rect_matrix
